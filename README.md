...
Create a Vercel project from this repository with `app/public-website` as the Root Directory. Vercel detects Next.js automatically. Use the Production environment for the following values:
